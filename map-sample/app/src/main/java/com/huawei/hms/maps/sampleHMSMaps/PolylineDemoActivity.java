...
package com.huawei.hms.maps.sampleHMSMaps;
...
import com.huawei.hms.maps.sampleHMSMaps.utils.MapUtils;
...
import static com.huawei.hms.maps.sampleHMSMaps.utils.CheckUtils.checkIsEdit;
import static com.huawei.hms.maps.sampleHMSMaps.utils.CheckUtils.checkIsRight;
...
public class PolylineDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        if (null != mPolyline) {
            ...
            if (checkIsEdit(width)) {
                ...
                if (!checkIsRight(width)) {
                    ...
                    mPolyline.setWidth(Float.valueOf(width));
                }
            }
        }
    }
    ...
    public void getWidth(View v) {
        if (null != mPolyline) {
            polylineShown.setText("Circle width is " + mPolyline.getWidth());
        }
    }
